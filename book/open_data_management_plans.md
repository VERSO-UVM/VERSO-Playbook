...
> **Important distinction:** A DOI makes data *citable* but not necessarily *findable* on the internet. Plan for both by choosing repositories with good metadata indexing and registering datasets in discipline-specific catalogs.

### Prioritize Open, Accessible Data Formats

Preferred data formats should be:

- **Community-supported** – Widely used in your discipline
- **Machine-readable** – Processable by computers and analysis tools
- **Non-proprietary** – Not dependent on licensed software
- **Modifiable** – Can be opened and edited with standard tools

**Examples of accessible formats by data type:**
- Tabular data: CSV, HDF5, NetCDF
- Astronomy tables: FITS, AAS machine-readable tables
- Geospatial: GeoTIFF, NetCDF
- General: JSON, XML

**Formats to avoid:**
- Proprietary formats (Excel, Stata, SPSS)
- Locked PDF files
- Formats requiring expensive software licenses

> **Long-term accessibility:** Open formats ensure data remain usable even if commercial software becomes unavailable.
...
- **Zenodo** (https://zenodo.org) - Multidisciplinary, open-access repository with DOI assignment
...
- **Institutional repositories** – Check with your university library
...
- Does it accept your data type and format?
- Does it assign persistent identifiers (DOIs)?
- Will metadata be indexed and searchable?
- What preservation commitments does it make?
- What access and licensing options are available?
- Does it align with funder requirements?

**Where *not* to archive:**
- Personal websites
- Institutional home pages without preservation commitments
- Temporary cloud storage (AWS, Google Drive, Dropbox) without archival backup
- Ad hoc file servers

> **Best practice:** A curated, well-documented deposit has lasting value; a "data dump" rarely does.
...
- **Dublin Core** (http://purl.org/dc/elements/1.1/) - General metadata schema
- **Darwin Core** - Biodiversity data standard
- **Climate and Forecast (CF) conventions** - Geospatial and climate data metadata
...
- **Open Science 101** (https://openscience101.org/) - Comprehensive open science training
